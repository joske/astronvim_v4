  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        -- Todo
        ["<leader>D"] = { name = "TODOs" },
        ["<leader>Dt"] = { "<cmd>TodoTelescope<cr>", desc = "Open TODOs in Telescope" },
        ["<leader>Dq"] = { "<cmd>TodoQuickFix<cr>", desc = "Open TODOs in QuickFix" },
        ["<leader>Dx"] = { "<cmd>TodoTrouble<cr>", desc = "Open TODOs in Trouble" },
        -- Telescope
